...
export default function Dropdown(props) {
  ...
  useEffect(() => {
    setHeightEl(`${refHeight.current.scrollHeight}px`) //useEffect s'éxécute au montage du composant, dans ce cas, il
    //définit la hauteur du collapse déplié lors de sa première ouverture et la conserve dans refHeight
  }, [])
